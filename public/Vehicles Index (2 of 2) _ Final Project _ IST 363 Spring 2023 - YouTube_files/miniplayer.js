(function(g){var window=this;'use strict';var vib=function(a,b){g.V.call(this,{G:"button",Ia:["ytp-miniplayer-expand-watch-page-button","ytp-button","ytp-miniplayer-button-top-left"],X:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button","aria-keyshortcuts":"i","data-title-no-tooltip":"{{data-title-no-tooltip}}"},W:[{G:"svg",X:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},W:[{G:"g",X:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},W:[{G:"g",X:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},
W:[{G:"path",X:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]}]});this.F=a;this.Ra("click",this.onClick,this);this.updateValue("title",g.ST(a,"Expand","i"));this.update({"data-title-no-tooltip":"Expand"});g.nb(this,g.SS(b.Hc(),this.element))},wib=function(a){g.V.call(this,{G:"div",
N:"ytp-miniplayer-ui"});this.ag=!1;this.player=a;this.S(a,"minimized",this.Th);this.S(a,"onStateChange",this.xP)},xib=function(a){g.vT.call(this,a);
this.u=new g.NH(this);this.j=new wib(this.player);this.j.hide();g.GS(this.player,this.j.element,4);a.yg()&&(this.load(),g.Op(a.getRootNode(),"ytp-player-minimized",!0))};
g.w(vib,g.V);vib.prototype.onClick=function(){this.F.Na("onExpandMiniplayer")};g.w(wib,g.V);g.k=wib.prototype;
...
g.k.aB=function(){};
g.k.Wr=function(){};
g.k.GD=function(){};g.w(xib,g.vT);g.k=xib.prototype;g.k.onVideoDataChange=function(){if(this.player.getVideoData()){var a=this.player.getVideoAspectRatio(),b=16/9;a=a>b+.1||a<b-.1;g.Op(this.player.getRootNode(),"ytp-rounded-miniplayer-not-regular-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.uT("miniplayer",xib);})(_yt_player);
